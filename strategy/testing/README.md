...
Shared backtesting harness and utilities. Importable as `import testing` from within the `strategy/` test suite (the `conftest.py` adds this directory to `sys.path`).
